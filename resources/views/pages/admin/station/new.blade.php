                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-alternative" name="account_nb"
                                        id="account_nb" aria-describedby="helpId" placeholder="" required>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label for="name"><b>Manager Telephone</b></label>
                                    <input type="text" class="form-control form-control-alternative" name="manager_tele"
                                        id="manager_tele" aria-describedby="helpId" placeholder="" required>
                                </div>
                            </div>
                        </div>
